...
function NavBar() {
  ...
  return (
    <div>
      ...
      {/* --- Header --- */}
      <header className="py-[15px] px-[20px]">
        <div className="flex justify-between items-center h-[48px] gap-[40px]">
          ...
          <div className="flex items-center gap-[20px]">
            ...
            <div className="font-bold font-integral text-[25px] translate-y-[-5px]">
              SHOP.CO
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <NavMenu items={navItems} className="flex flex-row gap-[20px]" />
          </div>

          {/* Search bar (desktop only) */}
          <div className="hidden md:flex md:h-[100%] md:flex-1 md:bg-[#f0f0f0] md:rounded-[30px] items-center md:px-[5px] md:py-[10px] md:m-[10px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
            ...
            <input
              className="md:w-[100%] md:ml-[5px] md:font-satoshi ml-2 focus:outline-none"
              type="text"
