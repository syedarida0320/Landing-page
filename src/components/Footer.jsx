...
const Newsletter = ({ onSubscribe }) => {
  ...
  return (
    <div className="update relative z-[1] m-[17px] flex flex-col items-center gap-[40px] rounded-[20px] bg-black py-[32px] px-[35px]">
      <div className="update-text font-integral text-[32px] font-bold leading-[35px] tracking-normal text-white">
        STAY UPTO DATE ABOUT OUR LATEST OFFERS
      </div>

      <div className="update-email flex flex-col gap-[12px]">
        <form
          onSubmit={handleSubmit}
          className="email flex items-center gap-[12px] rounded-[62px] bg-white py-[12px] px-[16px]"
        >
        ...
        <div className="subscribe-button">
          <button
            ...
            className="font-satoshi-medium flex w-full cursor-pointer justify-center gap-[14px] rounded-[62px] bg-white py-[12px] text-[14px] font-medium focus:outline-none"
          >
...
// --- FooterSection merged here ---
const FooterSection = ({ title, items }) => {
  return (
    <div className="footer-section mb-[30px] flex flex-col">
      <h4 className="mb-[8px] text-[14px] font-bold uppercase tracking-[2px] text-black font-satoshi-medium">
        {title}
      </h4>
      {items.map((item, idx) => (
        <p
          key={idx}
          className="cursor-pointer font-satoshi text-[14px] leading-[20px] text-[#555]"
        >
          {item}
        </p>
      ))}
...
const Footer = () => {
  ...
  return (
    <div className="contact-container flex w-full flex-col justify-center bg-white">
      ...
      <div className="contact-help relative z-0 mt-[-100px] bg-[#f0f0f0] px-[16px] pb-[30px] pt-[100px] font-satoshi">
        <div className="footer flex-col items-start gap-[30px]">
          <div className="brand footer-section mb-[30px] flex flex-col">
            <h2 className="mb-[10px] text-[28px] font-bold font-integral">SHOP.CO</h2>
            <p className="text-[14px] leading-[22px] text-[#555] font-satoshi">
          ...
          <div className="first-footer flex justify-start gap-[89px]">
          ...
          <div className="second-footer flex justify-start gap-[59px]">
        ...
        <div className="footer-bottom mt-[20px] flex flex-col items-center justify-between gap-[10px] border-t border-t-[#dddddd] pt-[20px] text-[14px] font-normal text-[#999]">
          <p>Shop.co &copy; 2000-2023, All Rights Reserved</p>
          <div className="payment-icons flex flex-row justify-center">
